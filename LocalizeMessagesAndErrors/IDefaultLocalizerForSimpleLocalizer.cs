...
/// <summary>
/// This is the interface for the <see cref="DefaultLocalizer{TResource}"/> class when used
/// by <see cref="SimpleLocalizer"/>.
/// </summary>
public interface IDefaultLocalizerForSimpleLocalizer
{
    /// <summary>
