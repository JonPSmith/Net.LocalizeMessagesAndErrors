...
public class ExamplesOfStatusGenericsLoc<TResource>
{
    ...
    public IStatusGeneric CheckNull(string? month)
    {
        ...
        var status = new StatusGenericLocalizer<TResource>(_localizeDefaultLocalizer);
    ...
    {
        var status = new StatusGenericLocalizer<string, TResource>(_localizeDefaultLocalizer);
    ...
    {
        var status = new StatusGenericLocalizer<DateTime, TResource>(_localizeDefaultLocalizer);
